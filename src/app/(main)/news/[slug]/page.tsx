                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-myco-dark/80">
                        {article.author === "redacted"
                          ? "With over 7 years of experience in the pharmaceutical industry and an MSc in Pharmaceutical Analysis."
                          : article.author === "redacted"
                          ? "An agronomist specializing in international horticultural business development."
                          : article.author === "redacted"
                          ? "Expert in sustainability, phytopharmaceutical therapeutics, and social enterprise entities."
