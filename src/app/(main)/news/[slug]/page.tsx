...
export default function NewsArticlePage() {
  ...
  return (
    <>
      ...
      <section className="py-12 bg-white px-5 flex flex-col items-center justify-center">
